...
class AnaliseApp:
    ...
    def create_widgets(self):
        ...
        self.label_selecionar = tk.Label(self.master, text="Selecionar Currículo:", bg=self.master['bg'])
        ...
        self.botao_limpar = tk.Button(self.master, text="Limpar Análises", command=self.limpar_analises)
        ...
        self.text_resumo = tk.Text(self.master, height=5, width=50)
        ...
        self.text_opiniao = tk.Text(self.master, height=5, width=50)
        ...
        self.text_nota = tk.Text(self.master, height=5, width=50) # Aumentei o width para corresponder aos outros inicialmente
